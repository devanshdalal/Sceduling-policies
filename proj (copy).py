...
x_series = [500,1000,2000]
# x_series = [10,50,100,500,1000,5000,10000,20000,50000]

y_series_1 = [x**2 for x in x_series]
y_series_2 = [x**3 for x in x_series]
y_series_3 = [x**3 for x in x_series]
y_series_4 = [x**3 for x in x_series]
y_series_5 = [x**3 for x in x_series]
y_series_6 = [x**3 for x in x_series]

mi,ma=29,20

_list = createVmList(state0, x_series[-1])
...
#plot data
plt.plot(x_series, y_series_1, label="FIRST_FIT")
# plt.plot(x_series, y_series_2, label="BEST_FIT")
# plt.plot(x_series, y_series_3, label="RAND_FIT")
plt.plot(x_series, y_series_4, label="FIRST_FIT2")
# plt.plot(x_series, y_series_5, label="BEST_FIT2")
# plt.plot(x_series, y_series_6, label="RAND_FIT2")
 
#add in labels and title
plt.xlabel("Querry List" , fontsize=20 )
plt.ylabel("Average Number of Hosts Used", fontsize=20)
